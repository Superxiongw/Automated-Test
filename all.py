...
if __name__ == '__main__':
    ...
    pytest.main(['ApiCase/testcases/test_SystemCompany.py','-sv','-q','--alluredir','./result'])
    os.system('allure generate ./result -o ./ApiCase/report --clean')
    # CreateFactory.py


    # pytest.main(['ApiCase/testcases/test_BaseMaterial.py','-sv','-q'])
    # pytest.main(['ApiCase/testcases/test_Login.py','-sv','-q'])
    # pytest.main(['ApiCase/testcases/test_SystemCompany.py','-sv','-q'])